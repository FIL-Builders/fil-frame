...
import { ContractVariables } from "~~/components/contract/ContractVariables";
 ...
 **/
export const DealClientUI = ({ contractName, className = "" }: DealClientUIProps) => {
