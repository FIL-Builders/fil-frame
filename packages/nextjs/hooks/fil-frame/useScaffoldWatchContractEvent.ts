...
import { addIndexedArgsToEvent, useDeployedContractInfo } from "~~/hooks/fil-frame";
import { ContractAbi, ContractName, UseScaffoldEventConfig } from "~~/utils/fil-frame/contract";
